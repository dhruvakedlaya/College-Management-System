...
<div class="header">
    ...
    <div class="dashboard">
		<div class="box">
			<h2><i class="fas fa-calendar-times leave-icon"></i></h2>
			<p>Apply leave</p>
			<a href='apply_leave.php' class="btn-view"><i class="fas fa-bed"></i>Apply</a>
		</div>
		<div class="box">
			 <h2><i class="fas fa-eye"></i></h2> 
			<p>View Leave</p>
			<a href='vStf_leave.php' class="btn-view"><i class="fas fa-eye"></i>View</a>
		</div>
<div class="footer">
